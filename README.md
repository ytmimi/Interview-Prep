...
*2)* When adding questions, please include the full question and any notes provided in the original source in a markdown cell. Also insure that each question is numberd. When adding answers to the answers.ipynb, a markdown cell referencing the question number should preceed all code cells.
